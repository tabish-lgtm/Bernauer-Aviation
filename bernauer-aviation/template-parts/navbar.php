...
<header class="navbar" data-nav-root>
	...
	<nav class="navbar__social" aria-label="<?php esc_attr_e( 'Social links', 'bernauer-aviation' ); ?>">
		<a class="navbar__icon" href="<?php echo esc_url( get_theme_mod( 'bernauer_instagram', '#' ) ); ?>" aria-label="Instagram">
		...
		<a class="navbar__icon" href="<?php echo esc_url( get_theme_mod( 'bernauer_facebook', '#' ) ); ?>" aria-label="Facebook">
			<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
